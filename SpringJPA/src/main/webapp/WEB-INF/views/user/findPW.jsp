                ...
                success(data) {
                    ...
                    $("#auth_email").on("propertychange change keyup paste input", function () {
                        if (data.auth_code === $("#auth_email").val()) {
                            ...
                            $("#btn_reg").attr("onclick", "location.href='/userChangePW'");
                        } else {
                            $("#auth_res").text("인증번호를 다시 확인해 주세요");
                            $("#auth_res").css('color', 'red');
                            $("#btn_reg").attr("onclick", "");
                    ...
                    <div class="card d-flex blur justify-content-center shadow-lg my-sm-0 my-sm-6 mt-8 mb-5">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg p-3">
                                <h3 class="text-white text-primary mb-0">비밀번호 찾기</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="contact-form" method="post" autocomplete="off">
                                        ...
                                        <div class="col-md-6 ps-md-2">
                                            <div class="input-group input-group-static mb-4">
                                                <button type="button" onclick="findUserId();"
                                                        class="btn bg-gradient-primary mt-3 mb-0">인증번호 전송
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="button" id="btn_reg" onclick="" class="btn bg-gradient-primary mt-3 mb-0">전송
                                        </button>
                                    </div>
                                </div>
                            </form>
